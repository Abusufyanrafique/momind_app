            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(AppStrings.want, size: 17, color: Color(0xFF464749), fontFamily: "fontFamily", fontWeight: null),
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(AppStrings.plan, size: 13, color: Colors.black, fontFamily: "fontFamily", fontWeight: null),
                    const SizedBox(height: 12),
                    Row(
                      children: [
